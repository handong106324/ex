...
public class HMAC {
     ...
     * @return
     */
    public static String init(String sec,String data) {
        SecretKey key = new SecretKeySpec(sec.getBytes(), "HmacMD5");
...
//            key = generator.generateKey();
    ...
    public void test( ) {
        ...
        String mm = HMAC.encryptHMAC(ll,ApiFactory.getKey("HB").getSecret());
        System.out.println(mm + ":" + "b0xxxxxx-c6xxxxxx-94xxxxxx-dxxxx");
    }
